...
import com.streamflow.app.data.remote.auth.AuthInterceptor
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideStreamFlowApiService(
        retrofit: Retrofit
    ): StreamFlowApiService {
        return retrofit.create(StreamFlowApiService::class.java)
    }
}
